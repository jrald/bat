init = function(){
      ...
      jarallax.addAnimation('.well-fieldgrass .f2',[{progress: ftop + "%", top: "-5%"}, {progress: "90%", top: "-60%"}]);
      jarallax.addAnimation('.well-fieldgrass .f3',[{progress: ftop + "%", top: "-10%"}, {progress: "70%", top: "-50%"}]);
      jarallax.addAnimation('.well-fieldgrass .f4',[{progress: ftop + "%", top: "-15%"}, {progress: "40%", top: "-30%"}]);
